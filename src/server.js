...
// Proxy vers le service statistiques
app.use(
  '/api/statistics',
  authMiddleware,
  createProxyMiddleware(proxyConfig.statisticsService),
)
...
app.get('/health', (req, res) => {
  res.json({
    ...
    services: {
      ...
      statisticsService: process.env.STATISTICS_SERVICE_URL,
    },
  })
})
...
app.listen(PORT, HOST, () => {
  ...
  console.log(`   - /api/statistics    → ${process.env.STATISTICS_SERVICE_URL}`)
  console.log(`   - /api/statistique → Statistiques & Reporting (intégré)`)
  console.log(`   - /api/statistique/hopitaux/:id → Statistiques par hôpital`)
